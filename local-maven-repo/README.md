...
cd jmc/core
mvn clean install
cp org.openjdk.jmc.common/target/common-8.1.0-SNAPSHOT.jar ../../local-maven-repo
cp org.openjdk.jmc.flightrecorder/target/flightrecorder-8.1.0-SNAPSHOT.jar ../../local-maven-repo
cp org.openjdk.jmc.flightrecorder.configuration/target/flightrecorder.configuration-8.1.0-SNAPSHOT.jar ../../local-maven-repo
cp org.openjdk.jmc.flightrecorder.rules/target/flightrecorder.rules-8.1.0-SNAPSHOT.jar ../../local-maven-repo
cp org.openjdk.jmc.flightrecorder.rules.jdk/target/flightrecorder.rules.jdk-8.1.0-SNAPSHOT.jar ../../local-maven-repo
cp org.openjdk.jmc.jdp/target/jdp-8.1.0-SNAPSHOT.jar ../../local-maven-repo
```
